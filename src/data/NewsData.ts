...
export const sampleNews: NewsArticle[] = [
  {
    id: '1',
    title: 'Government Announces Major Infrastructure Investment Plan for 2025',
    slug: 'government-announces-major-infrastructure-investment-plan-2025',
    excerpt:
      'The cabinet has approved a comprehensive Tk 50,000 crore infrastructure development package targeting transportation, energy, and digital connectivity across the nation.',
    content:
      'The government today unveiled an ambitious infrastructure investment plan worth Tk 50,000 crore, marking one of the largest development initiatives in recent history. The comprehensive package focuses on three key sectors: transportation networks, renewable energy infrastructure, and nationwide digital connectivity expansion...',
    category: 'News',
    subcategory: 'National',
    author: 'Rahman Ahmed',
    publishedAt: '2025-11-28T08:30:00Z',
    imageUrl:
  ...
  },
  {
    id: '2',
    title:
      'Opposition Parties Unite to Form Coalition Ahead of Local Elections',
    slug: 'opposition-parties-unite-coalition-local-elections',
    excerpt:
      'In a historic move, five major opposition parties have announced the formation of a unified coalition to contest upcoming municipal elections scheduled for early 2026.',
    content:
      'Political observers are calling it a watershed moment as five previously divided opposition parties announced their decision to form a grand coalition...',
    category: 'News',
    subcategory: 'Politics',
    author: 'Fatima Begum',
    publishedAt: '2025-11-28T07:15:00Z',
    imageUrl:
      'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=800&q=80',
    isFeatured: true,
    views: 8934,
    tags: ['politics', 'elections', 'coalition'],
  },
  {
    id: '3',
    title: 'Central Bank Raises Interest Rates to Combat Rising Inflation',
    slug: 'central-bank-raises-interest-rates-combat-inflation',
    excerpt:
      'Bangladesh Bank increases policy rate by 50 basis points in response to persistent inflationary pressures, affecting lending costs across all sectors.',
    content:
      'In its latest monetary policy announcement, Bangladesh Bank has raised the benchmark interest rate by 50 basis points to 7.25%, marking the fourth consecutive rate hike this year...',
    category: 'News',
    subcategory: 'Economy',
    ...
    isBreaking: true,
    views: 12567,
    tags: ['economy', 'banking', 'inflation'],
  },
  {
    id: '4',
    title:
      'EXCLUSIVE: Inside the Mega Corruption Scandal Shaking the Energy Sector',
    slug: 'exclusive-mega-corruption-scandal-energy-sector',
    excerpt:
      'FlipSide24 investigation reveals a web of corruption involving high-profile officials and billions in misappropriated funds from renewable energy projects.',
    content:
      "A six-month investigation by FlipSide24 has uncovered what appears to be one of the largest corruption scandals in the country's energy sector history...",
    category: 'Exclusive',
    author: 'Investigation Team',
    publishedAt: '2025-11-27T22:00:00Z',
    imageUrl:
      'https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=800&q=80',
    isFeatured: true,
    isEditorPick: true,
    views: 45230,
    tags: ['exclusive', 'corruption', 'energy'],
  },
  {
    id: '5',
    title:
      'RED FLAG: Viral Video Claiming Bridge Collapse is Digitally Altered',
    slug: 'red-flag-viral-video-bridge-collapse-fake',
    excerpt:
      'Our fact-checking team reveals the widely circulated video of a bridge collapse is a sophisticated digital manipulation combining footage from multiple incidents.',
    content:
      'A video that has been shared millions of times across social media platforms, purportedly showing a major bridge collapse in Sylhet, has been confirmed as digitally manipulated...',
    category: 'Red Flag',
    subcategory: 'Rumour Scan',
    author: 'Fact Check Desk',
    publishedAt: '2025-11-27T18:30:00Z',
    imageUrl:
      'https://images.unsplash.com/photo-1585776245991-cf89dd7fc73a?w=800&q=80',
    views: 28945,
    tags: ['fact-check', 'misinformation', 'viral'],
  },
  {
    id: '6',
    title: 'Bangladesh Cricket Team Eyes Historic Series Win Against Australia',
    slug: 'bangladesh-cricket-historic-series-win-australia',
    excerpt:
      'The Tigers stand on the brink of their first-ever Test series victory in Australia as they head into the final match with a 1-0 lead.',
    content:
      'In what cricket pundits are calling a fairytale campaign, the Bangladesh national cricket team has positioned themselves for a historic achievement...',
    category: 'Features',
    subcategory: 'Sports',
    author: 'Sports Desk',
    publishedAt: '2025-11-27T15:00:00Z',
    imageUrl:
  ...
  {
    id: '7',
    title: 'New Study Reveals Impact of Climate Change on Sundarbans Ecosystem',
    slug: 'study-climate-change-sundarbans-ecosystem',
    excerpt:
      "Research conducted over five years shows alarming changes in the world's largest mangrove forest, with significant implications for biodiversity.",
    content:
      'A comprehensive five-year study by international researchers has documented unprecedented changes in the Sundarbans ecosystem...',
    category: 'Research',
    ...
    isEditorPick: true,
    views: 9876,
    tags: ['environment', 'research', 'sundarbans'],
  },
  {
    id: '8',
    title: 'The Lost Heritage: Discovering Forgotten Temples of Ancient Bengal',
    slug: 'lost-heritage-forgotten-temples-ancient-bengal',
    excerpt:
      'An archaeological expedition uncovers a cluster of previously unknown Hindu temples dating back to the Pala dynasty era in northern Bangladesh.',
    content:
      "In a remarkable discovery that rewrites parts of Bengal's architectural history, a team of archaeologists has uncovered the remains of seven previously unknown temples...",
    category: 'Features',
    subcategory: 'History',
    ...
    views: 15678,
    tags: ['history', 'archaeology', 'heritage'],
  },
  {
    id: '9',
    title: 'EDITORIAL: The Path Forward for Democratic Institutions',
    slug: 'editorial-path-forward-democratic-institutions',
    excerpt:
      'As Bangladesh navigates challenging political waters, strengthening democratic institutions remains paramount for sustainable progress.',
    content:
      'The health of a democracy is measured not by its moments of triumph but by how it handles its trials. Recent events have tested our institutions...',
    category: 'Editorial',
    ...
    isEditorPick: true,
    views: 23456,
    tags: ['editorial', 'democracy', 'politics'],
  },
  {
    id: '10',
    title: 'Dhaka International Film Festival Announces 2025 Lineup',
    slug: 'dhaka-film-festival-2025-lineup',
    excerpt:
      'The prestigious festival will feature 120 films from 45 countries, with special focus on South Asian independent cinema.',
    content:
      'The 23rd Dhaka International Film Festival has announced its official selection, featuring a diverse lineup of 120 films spanning 45 countries...',
    category: 'Features',
    subcategory: 'Cinema',
    ...
    views: 12345,
    tags: ['cinema', 'festival', 'culture'],
  },
  {
    id: '11',
    title: 'Major Drug Trafficking Ring Busted in Joint Operation',
    slug: 'drug-trafficking-ring-busted-joint-operation',
    excerpt:
      'Law enforcement agencies seize narcotics worth Tk 500 crore in the largest anti-drug operation in recent years.',
    content:
      'In a coordinated operation involving multiple law enforcement agencies, authorities have dismantled what is believed to be the largest drug trafficking network...',
    category: 'News',
    subcategory: 'Crime',
    author: 'Crime Desk',
    ...
    views: 34567,
    tags: ['crime', 'drugs', 'police'],
  },
  {
    id: '12',
    title: 'Bangladesh-India Water Sharing Talks Resume After Two-Year Hiatus',
    slug: 'bangladesh-india-water-sharing-talks-resume',
    excerpt:
      'Senior officials from both countries meet in New Delhi to discuss the long-pending Teesta water sharing agreement.',
    content:
      'After a prolonged diplomatic pause, Bangladesh and India have resumed discussions on the contentious Teesta water sharing issue...',
    category: 'News',
    subcategory: 'International Relations',
    author: 'Diplomatic Correspondent',
    publishedAt: '2025-11-24T16:00:00Z',
    imageUrl:
      'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80',
    views: 19876,
    tags: ['diplomacy', 'india', 'water'],
  },
  {
    id: '13',
    title: 'Dhaka International Film Festival Announces 2025 Lineup',
...
export const breakingNews = [
  'BREAKING: Government announces major infrastructure investment plan worth Tk 50,000 crore',
  'Central Bank raises interest rates by 50 basis points to combat inflation',
  'Opposition parties form historic coalition ahead of local elections',
  'Tigers lead Test series 1-0 against Australia',
  'Major drug trafficking ring busted in joint operation',
];
